class OverallController < ApplicationController
  def index
    ...
    @runners =  Runner.select("firstname, surname, entryclass, non_compete, classifier1, school, day1_score, day2_score, time1, float_time1, float_time2, time2, (IFNULL(day1_score, 9999) + IFNULL(day2_score, 9999)) as total")
                    .where.not(classifier1: 1).order("entryclass, non_compete, total, classifier1, float_time1")
